...
export function WithdrawalCenter({ activeSection, onNavigate }: { activeSection: ActiveSection; onNavigate: (section: Exclude<ActiveSection, 'Retiros'>) => void }) {
  ...
  return <div className="withdrawal-center">
    ...
    <section className="mt-2 rounded-3xl bg-white p-6 shadow-sm">
      ...
      {groups.length > 0 && <div className="withdrawal-groups-panel mt-7"><p className="newgen-registered-title text-sm font-black text-slate-800">Grupos registrados</p><div className={`withdrawal-groups-layout mt-3 grid gap-4 lg:grid-cols-[280px_minmax(0,1fr)] ${selectedGroup ? 'has-open-group' : ''}`}>
